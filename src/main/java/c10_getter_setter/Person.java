...
public class Person {
    ...
    // person3의 age를 20으로 정하고,
    // person4의 name을 김삼, age를 30으로 변경한 후, 바뀐 필드에만 콘솔에 출력하시오.

    public void setAge(int age) {
        // method이기 때문에 {} 내부에 코드를 작성할 수 있음.
        // -> 이를 통해 데이터 유효성 검증을 위한 부분을 추가할 수 있음
        // 조건문을 적용을 해서 0 이상의 값만 입력이 가능하게끔 코드르 작성하면 됩니다.
