...
public class Constructor {
    ...
    // 매개변수 생성자를 직접 만드세요 -> 매개변수는 String title로 고정합니다.
    // 생성자가 호출될 때 RequiredArgsConstructor(int 매개변수를 필수로 요구하는 생성자)가 콘솔에 찍히도록 작성하세요.

    // 이후 ConstructorMin.java에서 Constructor constructor4 = new Constructor("김일"); 을 통해 객체를 생성하세요
    // 김일 이름을 가진 객체의 num 필드에 20을 입력하고
    // 콘솔창에 constructor04의 name과 num을 출력하세요
