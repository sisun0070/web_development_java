...
/*
    배열의 필요성 :
        여태까지의 수업을 기준으로 하면 10 개의 정수형 데이터를 저장하려면 int 변수를 10개 선언해서 저장해야 했습니다.
        ...
        일반 변수 : 데이터를 직접 가지는 변수
            byte, short, int, double 등 기본 데이터 타임(자료형)을 가지는 경우
...
//        System.out.println(arr2);
        ...
        // Streing은 기본 자료형이 아니라 클래스이기 때문에 실제로는 객체 생성을 통해 데이터를 삽입한다는 근거 :
...
//        }
        ...
        // 그렇다면 학교 전교생 혹읜 재직자 숫자와 같이 명확하지 않은 배열에서 각 요소를 출력하기 위한 방법
