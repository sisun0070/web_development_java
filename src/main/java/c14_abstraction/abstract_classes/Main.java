...
/*
    ...
    추상클래스
        ...
        추상 클래스의 목적
            ...
            2. 구체적인 구현 강제 : 추상 메서드르 통해 서브 클래스가 반드시 특정 메서드를 구현할 수 있도록 강제할 수 있다.
            3. 코드의 재사용성 : 중복되는 코드르 줄이고, 유지 보수성을 높일 수 있다.

        추상 클래스에서 주의할 점 :
            - 추상 클래스는 객체를 생성할 수 없다.

        super 키워드 - 슈퍼 클래스의 멤버 및 메서드에 접근하기 위해서 사용
            1. 서브 클래스에서 슈퍼 클래스를 생성자를 호출할 때 사용 -> super(매개변수)
