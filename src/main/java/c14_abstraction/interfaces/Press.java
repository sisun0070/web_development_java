...
public interface Press {
    // 5번 라인의 의미는 실제로는 public final String NAME= "buttion";과 동일하다.
    String NAME = "button";     // 상수이기 때문에 선언과 동시에 초기화가 이루어져야 함 void onPressed();
...
//    public default void pop();  // 일반 베서드 선언 불가능
}
