        ...
        추상 클래스와의 차이점
            - 추상 클래스
                1. 부분 구현 허용 : 추상 클래스는 추상 메서드 뿐만 아니라 일반 메서드(구현이 포함된 메서드)도
                    포함할 수 있다.
                2. 상태 저장 가능 : 추상 클래슨는 인스턴스 변수(상태)를 가질 수 있다.
                3. 단일 상속 : 클래슨는 하나의 추상 클래슴나 상속 받을 수 있다.
                4. 생성자 : 추상 클래스는 생성자를 가질 수 있다.
                5. 다양한 접근 제어자(Access Modifer) : 추상 클래스의 메서드와 변수는 다양한 접근 제어자
            ...
            - 인터페이스
                ...
                4. 생성자 없음 : 인터페잇느느 생성자를 가질 수 없다. -> 일단 멤버 변수(인스턴스 변수)에서 없기
...
public class Main {
    public static void main(String[] args) {
        ...
        /*
            ...
            구조를 이해하셔야 합니다!!!!
            RemoteController 의 객체를 생성했는데, 그 객체의 이름이 remoteController입니다.
            클래스1명 객체명 = new 생성자(argument1, argument2. ...)
            클래스1명 객체명 = new 클래서1명(new 클래스2명(), new 클래서3명())

            이상의 경우 new 클래스2명(), new 클래스3명()을 통해 객체 생성은 이미 완료가 되었습니다.
            다만, 여태까지와의 차이점은 new 클래스명(), new 클래스3명()에 해당하는 객체명이 없을 뿐입니다.
...
/*
    1. VolumeDownButton, VolumeBotton 클래스를 만들고 method들 구현하세요
