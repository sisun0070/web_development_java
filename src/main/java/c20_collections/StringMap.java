...
/*
    Map
        특징 :
            ...
            - 키는 중복을 허용하지 않으며, 값은 중복이 가능합니다. -> JSON이라는 형태와 가장 유사하기 때문
...
public class StringMap {
    public static void main(String[] args) {
        ...
        // HashMap 생성 및 초기화 -> Key와 Value가 들어가기 때문에 제네릭으로 두 개의 타입을 설정할 필요가 있음
        ...
        /*
            ...
            입력이 끝나셧으면 출력해보세요. -List 출력 방법과 동일합니다.
        */
        ...
        System.out.println(map.get("20230001"));        // 출력값 -> 황지선
        ...
        boolean searchSuccessFlah2 = map.containsKey("20240007");
        System.out.println(searchSuccessFlag1);
        System.out.println(searchSuccessFlah2);
